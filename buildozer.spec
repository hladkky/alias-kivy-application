...
source.exclude_dirs = .git, .vscode, tests, bin
...
requirements = python3,kivy==2.0.0,https://github.com/kivymd/KivyMD/archive/master.zip,pillow,sdl2_ttf==2.0.15,kivmob
